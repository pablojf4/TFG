...
public class Bullet : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //Encuentra los l�mites de la pantalla para el movimiento de la bala
        ...
        //Se revisa si la posicion de la bala en el eje y es superior al margen superior de la c�mara
