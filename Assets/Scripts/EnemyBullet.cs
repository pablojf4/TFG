...
public class EnemyBullet : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //Encuentra los límites de la pantalla para el movimiento de la bala enemiga
        ...
        //Se revisa si la posición de la bala enemiga en el eje y es menor al margen inferior de la cámara
